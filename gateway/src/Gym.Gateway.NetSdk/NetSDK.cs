...
namespace NetSDKCS
{
    public static class NETClient
    {
        ...
        private static Dictionary<EM_ErrorCode, string> zh_cn_String = new Dictionary<EM_ErrorCode, string>()
        {
            ...
            {EM_ErrorCode.NET_SYSTEM_ERROR,"Windows"},
            ...
            {EM_ErrorCode.NET_SDK_INIT_ERROR,"SDK"},
            {EM_ErrorCode.NET_SDK_UNINIT_ERROR,"SDK"},
            {EM_ErrorCode.NET_RENDER_OPEN_ERROR,"render"},
            {EM_ErrorCode.NET_DEC_OPEN_ERROR,""},
            {EM_ErrorCode.NET_DEC_CLOSE_ERROR,""},
            {EM_ErrorCode.NET_MULTIPLAY_NOCHANNEL,"0"},
            ...
            {EM_ErrorCode.NET_NOT_SUPPORTED,"SDK"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_DSPCAP,"DSP"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_FUNCNAME,"232"},
            {EM_ErrorCode.NET_ERROR_GETCFG_485DECODER,""},
            {EM_ErrorCode.NET_ERROR_GETCFG_232COM,"232"},
            ...
            {EM_ErrorCode.NET_ERROR_SETCFG_232COM,"232"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_SESSION,"Session"},
            ...
            {EM_ErrorCode.NET_LOGIN_ERROR_PROTOCOL3_ONLY,"3"},
            {EM_ErrorCode.NET_LOGIN_ERROR_UKEY_LOST,"UU"},
            {EM_ErrorCode.NET_LOGIN_ERROR_NO_AUTHORIZED,"IP"},
            {EM_ErrorCode.NET_LOGIN_ERROR_USER_OR_PASSOWRD,""},
            {EM_ErrorCode.NET_RENDER_SOUND_ON_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_SOUND_OFF_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_SET_VOLUME_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_ADJUST_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_PAUSE_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_SNAP_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_STEP_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_FRAMERATE_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_DISPLAYREGION_ERROR,"Render"},
            {EM_ErrorCode.NET_RENDER_GETOSDTIME_ERROR,"Render"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_VIDEO_OSD,"OSD"},
            {EM_ErrorCode.NET_ERROR_SETCFG_VIDEO_OSD,"OSD"},
            {EM_ErrorCode.NET_ERROR_GETCFG_GPRSCDMA,"CDMA\\GPRS"},
            {EM_ErrorCode.NET_ERROR_SETCFG_GPRSCDMA,"CDMA\\GPRS"},
            {EM_ErrorCode.NET_ERROR_GETCFG_IPFILTER,"IP"},
            {EM_ErrorCode.NET_ERROR_SETCFG_IPFILTER,"IP"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_MMS,"mms"},
            {EM_ErrorCode.NET_ERROR_SETCFG_MMS,"mms"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_OSDENABLE,"osd"},
            {EM_ErrorCode.NET_ERROR_SETCFG_OSDENABLE,"osd"},
            {EM_ErrorCode.NET_ERROR_SETCFG_ENCODERINFO,""},
            {EM_ErrorCode.NET_ERROR_GETCFG_TVADJUST,"TV"},
            {EM_ErrorCode.NET_ERROR_SETCFG_TVADJUST,"TV"},
            ...
            {EM_ErrorCode.NET_SDK_LOGOUT_ERROR,"SDK"},
            {EM_ErrorCode.NET_ERROR_GET_VEHICLE_CFG,""},
            {EM_ErrorCode.NET_ERROR_SET_VEHICLE_CFG,""},
            {EM_ErrorCode.NET_ERROR_GET_ATM_OVERLAY_CFG,"atm"},
            {EM_ErrorCode.NET_ERROR_SET_ATM_OVERLAY_CFG,"atm"},
            {EM_ErrorCode.NET_ERROR_GET_ATM_OVERLAY_ABILITY,"atm"},
            ...
            {EM_ErrorCode.NET_ERROR_GET_SIP_CFG,"SIP"},
            {EM_ErrorCode.NET_ERROR_SET_SIP_CFG,"SIP"},
            {EM_ErrorCode.NET_ERROR_GET_SIP_ABILITY,"SIP"},
            {EM_ErrorCode.NET_ERROR_GET_WIFI_AP_CFG,"WIFI ap"},
            {EM_ErrorCode.NET_ERROR_SET_WIFI_AP_CFG,"WIFI ap"},
            ...
            {EM_ErrorCode.NET_ERROR_MAC_VALIDATE_FAILED,"MAC "},
            {EM_ErrorCode.NET_ERROR_GET_INSTANCE,""},
            {EM_ErrorCode.NET_ERROR_JSON_REQUEST,"jason"},
            {EM_ErrorCode.NET_ERROR_JSON_RESPONSE,"jason"},
            ...
            {EM_ErrorCode.NET_ERROR_GETCFG_MACFILTER,"MAC"},
            {EM_ErrorCode.NET_ERROR_SETCFG_MACFILTER,"MAC"},
            {EM_ErrorCode.NET_ERROR_GETCFG_IPMACFILTER,"IP/MAC"},
            {EM_ErrorCode.NET_ERROR_SETCFG_IPMACFILTER,"IP/MAC"},
            {EM_ErrorCode.NET_ERROR_OPERATION_OVERTIME," "},
            {EM_ErrorCode.NET_ERROR_SENIOR_VALIDATE_FAILED,""},
            {EM_ErrorCode.NET_ERROR_DEVICE_ID_NOT_EXIST,"ID"},
            ...
            {EM_ErrorCode.NET_ERROR_NOT_SUPPORT_F6,"F6"},
            ...
            {EM_ErrorCode.NET_RENDER_ENABLELARGEPICADJUSTMENT_ERROR,"Render"},
            ...
            {EM_ErrorCode.NET_ERROR_PARAM_DWSIZE_ERROR,"dwsize"},
            ...
            {EM_ErrorCode.NET_ERROR_NEED_ENCRYPTION_PASSWORD,"ip,"},
            {EM_ErrorCode.NET_ERROR_NOSUPPORT_RECORD,""},
            {EM_ErrorCode.NET_ERROR_SERIALIZE_ERROR,""},
            {EM_ErrorCode.NET_ERROR_DESERIALIZE_ERROR,""},
            {EM_ErrorCode.NET_ERROR_LOWRATEWPAN_ID_EXISTED,"ID"},
            {EM_ErrorCode.NET_ERROR_LOWRATEWPAN_ID_LIMIT,"ID"},
            ...
            {EM_ErrorCode.NET_ERROR_2D_CODE, "2D code"},
            {EM_ErrorCode.NET_ERROR_INVALID_REQUEST, "RPC"},
            ...
            {EM_ErrorCode.ERR_INTERNAL_CREATE_SOCKET,"socket"},
            {EM_ErrorCode.ERR_INTERNAL_LISTEN_FAILED,""},
            {EM_ErrorCode.NET_ERROR_FACE_RECOGNITION_SERVER_GROUP_ID_EXCEED, "ID" },
            {EM_ErrorCode.ERR_NOT_SUPPORT_HIGHLEVEL_SECURITY_LOGIN, "" },
            {EM_ErrorCode.NET_ERROR_PHOTOSIZE_EXCEEDSLIMIT, ""},
            {EM_ErrorCode.NET_ERROR_USERID_INVALID, "ID"},
            {EM_ErrorCode.NET_ERROR_EXTRACTFEATURE_FAILED, ""},
            {EM_ErrorCode.NET_ERROR_PHOTO_EXIST, ""},
            {EM_ErrorCode.NET_ERROR_PHOTO_OVERFLOW, ""},
            {EM_ErrorCode.NET_ERROR_PHOTO_FORMAT, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_PARAM, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_PASSWORD, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_FINGERPRINT, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_FACE, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_CARD, ""},
            {EM_ErrorCode.NET_ERROR_INVALID_USER, ""},
            {EM_ErrorCode.NET_ERROR_GET_SUBSERVICE, ""},
            {EM_ErrorCode.NET_ERROR_GET_METHOD, ""},
            {EM_ErrorCode.NET_ERROR_GET_SUBCAPS, ""},
            {EM_ErrorCode.NET_ERROR_UPTO_INSERT_LIMIT, ""},
            {EM_ErrorCode.NET_ERROR_UPTO_MAX_INSERT_RATE, ""},
            {EM_ErrorCode.NET_ERROR_ERASE_FINGERPRINT, ""},
            {EM_ErrorCode.NET_ERROR_ERASE_FACE, ""},
            {EM_ErrorCode.NET_ERROR_ERASE_CARD, ""},
            {EM_ErrorCode.NET_ERROR_NO_RECORD, ""},
            {EM_ErrorCode.NET_ERROR_NOMORE_RECORDS, "，"},
            {EM_ErrorCode.NET_ERROR_RECORD_ALREADY_EXISTS, "，"},
            {EM_ErrorCode.NET_ERROR_EXCEED_MAX_FINGERPRINT_PERUSER, ""},
            {EM_ErrorCode.NET_ERROR_EXCEED_MAX_CARD_PERUSER, ""},
            {EM_ErrorCode.NET_ERROR_EXCEED_ADMINISTRATOR_LIMIT, ""},
            {EM_ErrorCode.NET_ERROR_CARD_NUM_EXIST, ""},
            {EM_ErrorCode.NET_ERROR_FINGERPRINT_EXIST, ""},
            {EM_ErrorCode.NET_ERROR_FINGERPRINT_DOWNLOAD_FAIL, "URL"},
            {EM_ErrorCode.NET_ERROR_DOOR_IN_NORMALLY_OPEN_STATUS, ""},
            {EM_ErrorCode.NET_ERROR_DOOR_IN_NORMALLY_CLOSED_STATUS, ""},
            {EM_ErrorCode.NET_ERROR_DOOR_IN_INTERLOCK_STATUS, ""},
            {EM_ErrorCode.NET_ERROR_DO_NOT_EDIT, ""},
            {EM_ErrorCode.NET_ERROR_BINDING, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FEATURE_SIZE_ERROR, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_NO_FACE_DETECTED, "0"},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_MULTI_FACE_DETECTED, "，"},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_PICTURE_DECODING_ERROR, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_LOW_PICTURE_QUALITY, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_NOT_RECOMMENDED, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_FEATURE_ALREADY_EXIST, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_ANGLE_OVER_THRESHOLDS, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_RADIO_EXCEEDS_RANGE, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_OVER_EXPOSED, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_UNDER_EXPOSED, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_BRIGHTNESS_IMBALANCE, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_LOWER_CONFIDENCE, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_LOW_ALIGN, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FRAGMENTARY_FACE_DETECTED, "、"},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_PUPIL_DISTANCE_NOT_ENOUGH, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_DATA_DOWNLOAD_FAILED, ""},
            {EM_ErrorCode.NET_ERROR_NORMAL_USER_NOTSUPPORT, ""},
            {EM_ErrorCode.NET_ERROR_CITIZENID_EXIST, ""},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_FFE_FAILED, "，（）"},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_PHOTO_FEATURE_FAILED_FOR_FA, "，，"},
            {EM_ErrorCode.NET_ERROR_FACEMANAGER_FACE_DATA_PHOTO_INCOMPLETE, ""}
        };
        #endregion //<< constant >>
        ...
        /// 
        /// </summary>
        /// <param name="isThrow">throw expection or not </param>
        ...
        /// 
        /// </summary>
        /// <param name="errorCode">SDK error code SDK</param>
        /// <returns>error message description </returns>
        ...
        /// <param name="initParam">initialization parameter,can input null SDK</param>
        /// <returns>failed return false, successful return true false true</returns>
                                                  ...
                                                  IntPtr dwUser, NETSDK_INIT_PARAM? stuInitParam)
        {
            ...
            try
            {
                ...
                // init SDK and set disconnect callback ( SDK)
                result = OriginalSDK.CLIENT_InitEx(cbDisConnect, dwUser, lpInitParam);
                NetGetLastError(result);
                if (!result) return false;

                // Timeout of login 
                // Tiemout of sub-connect 
                ...
                // set reconnect time ，
                // Set timeout and number of attempts ，
        ...
        /// 
        /// </summary>
        /// <param name="pchDVRIP">device IP IP</param>
        ...
        /// <param name="pCapParam">nSpecCap compensation parameter，nSpecCap = EM_LOGIN_SPAC_CAP_TYPE.SERVER_CONN，pCapParam fill in device serial number string(mobile dvr login) emSpecCap， EM_LOGIN_SPAC_CAP_TYPE.SERVER_CONN</param>
        /// <param name="deviceInfo">device information，for output parmaeter </param>
        /// <returns>failed return 0,successful return LoginID,after successful login, device Operation may be via this this value(device handle)corresponding to corresponding device.0，O</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's returns value，ID,Login</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="hWnd">display window handle. When value is 0(IntPtr.Zero), data are not decoded or displayed </param>
        /// <param name="rType">realplay type </param>
        /// <param name="cbRealData">real data callback <seealso cref="SetRealDataCallBack"/></param>
        ...
        /// <returns>failed return 0, successful return the real time monitorID(real time monitor handle),as parameter of related function. 0，0</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's returns value ID,Login</param>
        /// <param name="nChannelID">real time monitor channel NO.(from 0). </param>
        /// <param name="hWnd">display window handle. When value is 0(IntPtr.Zero), data are not decoded or displayed </param>
        /// <param name="rType">realplay type </param>
        /// <returns>failed return 0, successful return the real time monitorID(real time monitor handle),as parameter of related function. 0，0</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lRealHandle">monitor handle StartRealPlay returns value ID StartRealPlay</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// YUC
        /// </summary>
        /// <param name="lPlayHandle">play back handle </param>
        /// <param name="cYUVData">callback function </param>
        /// <param name="dwUser">user data, there is no data, please use IntPtr.Zero </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        ...
        /// <param name="nWaitTime">waite time </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <returns>failed return 0, successful return the playback ID(playback handle),as parameter of related function. 0，0</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">Device handles user login ID，Login</param>
        ...
        /// <param name="bTime">Whether by time(Currently use false) ，FALSE</param>
        /// <returns>true:success;false:failure false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="nChannelId">channel value ID</param>
        /// <param name="nRecordFileType">record file type  EM_QUERY_RECORD_TYPE </param>
        /// <param name="tmMonth">month </param>
        /// <param name="pchCardid">card id , nRecordFileType == EM_RECORD_TYPE_CARD，pchCardid; nRecordFileType == EM_RECORD_TYPE_FIELD，pchCardid</param>
        /// <param name="pRecordStatus">recorde status in some month </param>
        ...
        /// OSD
        /// </summary>
        /// <param name="lPlayHandle">PlayBackByTime returns value PlayBackByTime</param>
        /// <param name="lpOsdTime">return osd time OSD</param>
        /// <param name="lpStartTime">start time </param>
        /// <param name="lpEndTime">end time </param>
        /// <returns>true:success;false:failure false true</returns>
        ...
        ///  
        /// </summary>
        /// <param name="hPlayHandle">real handle or palyback handle 
        ///                            <para>StartRealPlay returns value StartRealPlay</para>
        ///                            <para>PlayBackByTime returns value PlayBackByTime</para></param>
        /// <param name="pchPicFileName">picture's saving name </param>
        /// <param name="eFormat">picture type </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        /// <param name="nChannelId">channel number </param>
        /// <param name="nRecordFileType">file type </param>
        /// <param name="tmStart">start time </param>
        /// <param name="tmEnd">end time </param>
        /// <param name="sSavedFileName">save file name </param>
        ...
        /// 
        /// </summary>
        /// <param name="lFileHandle">downloadsID DownloadByTime returns value ID DownloadByTime</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="nTotalSize">total download size(KB) </param>
        /// <param name="nDownLoadSize">the size have download(KB) </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <summary>
        /// ,param4， EM_A_EXTPTZ_ControlType 
        ...
        /// <param name="lParam1">Parameter1 details refer to EM_A_EXTPTZ_ControlType 1</param>
        /// <param name="lParam2">Parameter2 details refer to EM_A_EXTPTZ_ControlType 2</param>
        /// <param name="lParam3">Parameter3 details refer to EM_A_EXTPTZ_ControlType 3</param>
        ...
        /// <param name="param4"><para>support PTZ control extensive command，support these commands: 4</para> 
        ///                      <para>EM_A_EXTPTZ_ControlType.MOVE_ABSOLUTELY:Absolute motion control commands，param4 corresponding struct NET_PTZ_CONTROL_ABSOLUTELY</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.MOVE_CONTINUOUSLY:Continuous motion control commands，param4 corresponding struct NET_PTZ_CONTROL_CONTINUOUSLY</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.GOTOPRESET:PTZ control command, at a certain speed to preset locus，parm4 corresponding struct NET_PTZ_CONTROL_GOTOPRESET</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.SET_VIEW_RANGE:Set to horizon(param4 corresponding struct NET_PTZ_VIEW_RANGE_INFO</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.FOCUS_ABSOLUTELY:Absolute focus(param4 corresponding struct NET_PTZ_FOCUS_ABSOLUTELY</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.HORSECTORSCAN:Level fan sweep(param4 corresponding NET_PTZ_CONTROL_SECTORSCAN,param1、param2、param3 is invalid</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.VERSECTORSCAN:Vertical sweep fan(param4 corresponding NET_PTZ_CONTROL_SECTORSCAN,param1、param2、param3 is invalid</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.SET_FISHEYE_EPTZ:Control fish eye PTZ，param4corresponding to structure NET_PTZ_CONTROL_SET_FISHEYE_EPTZ</para>
        ///                      <para>EM_A_EXTPTZ_ControlType.SET_TRACK_START/SET_TRACK_STOP:param4 corresponding to structure NET_PTZ_CONTROL_SET_TRACK_CONTROL,dwStop set as FALSE，param1、param2、param3  is invalid</para></param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// PTZ
        /// </summary>
        /// <param name="lLoginID">ID，Login</param>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">loginID,login returns value ID</param>
        ...
        /// <param name="dwAlarmType">event type see EM_EVENT_IVS_TYPE </param>
        ...
        /// 
        /// </summary>
        /// <param name="lAnalyzerHandle">analyzerHandle:RealLoadPicture returns value RealLoadPicture</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">Login returns value ID</param>
        /// <param name="nSystemType">query type </param>
        /// <param name="pSysInfoBuffer">information buffer </param>
        /// <param name="maxlen">buffer max len </param>
        /// <param name="nSysInfolen">return information len </param>
        ...
        /// <param name="lLoginID">Login returns value ID</param>
        /// <param name="nSystemType">query type </param>
        /// <param name="obj">return information object </param>
        /// <param name="waittime">wait time </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="pLogBuffer">log buffer </param>
        /// <param name="nLogBufferLen">buffer len </param>
        /// <param name="pRecLogNum">return log number </param>
        /// <param name="waittime">wait time </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">Login returns value ID</param>
        /// <param name="pfcb">audio data callback </param>
        /// <param name="dwUser">user data </param>
        /// <returns>failed return zero, successful return non-zero(talk handle) 0,0</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lTalkHandle">StartTalk returns value StartTalk</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lTalkHandle">StartTalk returns value StartTalk</param>
        /// <param name="pSendBuf">send buffer </param>
        ...
        /// 
        /// </summary>
        /// <param name="pAudioDataBuf">audio buffer </param>
        /// <param name="dwBufSize">buffer size </param>
        ...
        /// </summary>
        /// <param name="lLoginID">loginID:login returns value ID</param>
        /// <param name="type">CtrlType </param>
        /// <param name="param">pointer to control param </param>
        /// <param name="waittime">wait time </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="lLoginID">loginID:login returns value ID</param>
        /// <param name="type">CtrlType </param>
        /// <param name="pInBuf">pointer to control in param </param>
        /// <param name="pOutBuf">pointer to control out param </param>
        ...
        /// <param name="obj">return information object </param>
        /// <param name="typeName">query struct type </param>
        /// <param name="waittime">waittime </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value ID</param>
        /// <param name="lChannel">Channel id </param>
        /// <param name="strCommand">Command string </param>
        /// <param name="obj">Object correspondence to the Command </param>
        /// <param name="typeName">obj's type </param>
        ...
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="emRecordType">Record Type </param>
        /// <param name="oCondition">search condition </param>
        /// <param name="tyCondition">type of condition struct </param>
        /// <param name="lFindID">lFindeHandle ID</param>
        ...
        /// 
        /// </summary>
        /// <param name="lFindeHandle">FindRecord's return value FindRecord</param>
        /// <param name="nMaxNum">max number of search </param>
        /// <param name="nRetNum">return number </param>
        /// <param name="ls">list of Record </param>
        /// <param name="tyRecord">typeof Record </param>
        /// <param name="waittime">Wait timeout, million second </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lFindHandle">FindRecord's return value FindRecord</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lFindHandle">FindRecord's return value FindRecord</param>
        /// <param name="nRecordCount">records' count </param>
        /// <param name="waittime">Wait timeout, million second </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value ID</param>
        /// <param name="pstInParam">In Param </param>
        /// <param name="pstOutParam">Out Param, dwsize need assign too </param>
        /// <returns>Find Handle </returns>
        ...
        /// 
        /// </summary>
        /// <param name="lFindHandle">StartFindNumberStat return value StartFindNumberStat</param>
        /// <param name="pstInParam">in param </param>
        /// <param name="pNumberStats">number stats' array. </param>
        /// <returns>larger than 0: success. small than 0: fail 0，0</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value ID</param>
        /// <param name="pInParam">in param </param>
        /// <param name="pOutParam">out param, not useful, dwsize need assign too </param>
        /// <param name="nWaitTime">Wait timeout, million second </param>
        /// <returns>Attach Handle </returns>
        ...
        /// 
        /// </summary>
        /// <param name="lAttachHandle">AttachVideoStatSummary returns value AttachVideoStatSummary</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">Login return value ID</param>
        /// <param name="TransComType">lower 2 bytes are serial type, 0:serial(232), 1:485 port; higher 2 bytes are channel number, start from 0  TransComType2,2</param>
        /// <param name="baudrate">serial baud rate,1~8 as 1200,2400,4800,9600,19200,38400,57600,115200 respectively </param>
        /// <param name="databits">serial data digit 4~8 represent 4~8 digits < /param>
        /// <param name="stopbits">serial stop digit 1 represent 1 digit, 2 represent 1-5 digit(s), 3 represent 2 digits </param>
        /// <param name="parity">serial inspection digit,1:odd,2:even,3: none  </param>
        /// <param name="cbTransCom">serial data callback, recall info sent from front-end device </param>
        /// <param name="dwUser">user data </param>
        /// <returns>successful return to transparent serial ID,failed return to 0. 0，0</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lTransComChannel">transparent serial ID, interface CreateTransComChannel value  CreateTransComChannel</param>
        /// <param name="byDatas">transparent serial data to send </param>
        /// <returns>successful return to TRUE,failed return to FALSE. false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lTransComChannel">transparent serial ID, interface CreateTransComChannel return value CreateTransComChannel</param>
        /// <returns>successful return to TRUE,failed return to FALSE false true</returns>
        ...
        /// <param name="szKey">Security Key </param>
        /// <returns>failed return false, successful return true  false true</returns>
        ...
        public static bool MatrixGetCameras(IntPtr lLoginID, out NET_MATRIX_CAMERA_INFO[] stuCameras, int nMaxCameraCount, int nWaitTime)
        {
            ...
            try
            {
                ...
                stuOutParam.pstuCameras = Marshal.AllocHGlobal(nBuflen);//
        ...
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object obj, Type typeName, int waittime, IntPtr pReserved = new IntPtr())
        {
            bool returnValue = false;
            IntPtr pInBuf = IntPtr.Zero;
            IntPtr pOutBuf = IntPtr.Zero;
            ...
            try
            {
                ...
                if (pInBuf != IntPtr.Zero && pOutBuf != IntPtr.Zero)
                {
                    returnValue = OriginalSDK.CLIENT_GetNewDevConfig(lLoginID, strCommand, lChannel, pInBuf,
                                                         nBufSize, out nError, waittime, pReserved);
                    if (returnValue == true)
                    {
        ...
        //get 
        public static bool GetNewDevConfig(IntPtr lLoginID, Int32 lChannel, string strCommand, ref object[] objs, Type typeName, int waittime, IntPtr pReserved = new IntPtr())
        {
            bool returnValue = false;
            IntPtr pInBuf = IntPtr.Zero;
            IntPtr pOutBuf = IntPtr.Zero;
            ...
            try
            {
                ...
                {
                    returnValue = OriginalSDK.CLIENT_GetNewDevConfig(lLoginID, strCommand, lChannel, pInBuf,
                                                         nInBufSize, out nError, waittime, pReserved);
        ...
        public static bool GetOperateAccessUserService(IntPtr lLoginID, string[] userid, out NET_ACCESS_USER_INFO[] stOutParam1, out NET_EM_FAILCODE[] stOutParam2, int nWaitTime)
        {
            ...
            try
            {
                int userInfoLen = Marshal.SizeOf(typeof(NET_ACCESS_USER_INFO));
                pInBuf = Marshal.AllocHGlobal(Marshal.SizeOf(stuInInfo));
                pOutBuf = Marshal.AllocHGlobal(Marshal.SizeOf(stuOutInfo));
                pOutInfoArrayBuf = Marshal.AllocHGlobal(userInfoLen * stuCount);
                ...
                for (int i = 0; i < stuCount; i++)
                {
                    Marshal.StructureToPtr(userInfo, IntPtr.Add(pOutInfoArrayBuf, userInfoLen * i), true);
                }
                ...
                for (int i = 0; i < stuCount; i++)
                {
                    IntPtr pDst = IntPtr.Add(pOutInfoArrayBuf, userInfoLen * i);
        ...
        /// <summary>
        /// 
        /// deletes the qualified personnel in the specified personnel group
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the input parameter of the interface</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE indicates success. FALSE Indicates failure</returns>
        public static bool DeletePersonByCondition(IntPtr lLoginID, ref NET_IN_DELETE_PERSON_BY_CONDITION_INFO pstuInParam, ref NET_OUT_DELETE_PERSON_BY_CONDITION_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DeletePersonByCondition(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value ID</param>
        /// <param name="stuInInfo">in param </param>
        /// <param name="stuOutInfo">out param </param>
        /// <param name="nWaitTime">Wait timeout, million second </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="emCfgOpType">config type </param>
        /// <param name="nChannelID">channel id </param>
        /// <param name="obj">config struct </param>
        /// <param name="waittime">waittime </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        public static bool GetSplitWindowsInfo(IntPtr lLoginID, object inParam, ref object outParam, int nWaitTime)
        {
            ...
            try
            {
                ...
                Marshal.StructureToPtr(outParam, outPtr, false);
        ...
        public static bool GetDevEncodeCaps(IntPtr lLoginID, NET_IN_ENCODE_CFG_CAPS stuInParam, ref NET_OUT_ENCODE_CFG_CAPS stuOutParam, int nWaitTime)
        {
            ...
            result = OriginalSDK.CLIENT_GetNewDevConfig(lLoginID, strCommand, stuInParam.nChannelId, stuIn.pchEncodeJson,
                                                         nBufSize, out nError, nWaitTime, new IntPtr());
            if (result)
            {
        ...
        public static IntPtr DownloadByRecordFile(IntPtr lLoginID, ref NET_RECORDFILE_INFO lpRecordFile, string sSavedFileName, fDownLoadPosCallBack cbDownLoadPos, IntPtr dwUserData, bool bUseUTCTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_DownloadByRecordFile(lLoginID, ref lpRecordFile, sSavedFileName, cbDownLoadPos, dwUserData, bUseUTCTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        /// <param name="pstInParam">real play  parameter in </param>
        /// <param name="pstOutParam">real play  parameter out </param>
        /// <param name="dwWaitTime">Waiting Time </param>
        /// <returns>failed return 0, successful return the realplay ID(realplay handle),as parameter of related function. 0，0</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        /// <param name="pstInParam">playback  parameter in </param>
        /// <param name="pstOutParam">playback  parameter out </param>
        /// <param name="dwWaitTime">Waiting Time </param>
        /// <returns>failed return 0, successful return the playback ID(playback handle),as parameter of related function. 0，0</returns>
        ...
        /// <summary>
        /// Download By Stream Data Type   
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        /// <param name="pstInParam">download parameter in </param>
        /// <param name="pstOutParam">download parameter Out </param>
        /// <param name="dwWaitTime">Waiting Time </param>
        /// <returns>failed return 0, successful return the download ID(download handle),as parameter of related function. 0，0</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">user LoginID:Login's return value ID，Login</param>
        /// <param name="pstInParam">Get Alarm ext module status parameter in </param>
        /// <param name="pstOutParam">Get Alarm ext module status parameter Out </param>
        /// <param name="dwWaitTime">Waiting Time </param>
        /// <returns></returns>
        ...
        /// <summary>
        /// ，, pstInParam = NET_IN_FACE_RECOGNITION_DETECT_MULTI_FACE_INFO pstOutParam
        ...
        /// <summary>
        /// ,CLIENT_FaceRecognitionDetectMultiFace, pstInParampstOutParam
        ...
        /// <summary>
        /// , lAttachHandleCLIENT_AttachDetectMultiFaceState 
        ...
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="stuInParam"></param>
        /// <param name="nWaitTime">waittime </param>
        /// <returns>failed return Intptr.Zero, successful return other; Intptr.Zero </returns>
        ...
        /// 
        /// </summary>
        /// <param name="lAttachHandle">AttachAnalyseTaskState return value; ID</param>
        /// <returns></returns>
        ...
        public static bool PushAnalysePictureFile(IntPtr lLoginID, ref NET_IN_PUSH_ANALYSE_PICTURE_FILE pInParam, ref NET_OUT_PUSH_ANALYSE_PICTURE_FILE pOutParam, int nWaitTime)
        {
            ...
            IntPtr ppInParam = IntPtr.Zero;
            IntPtr ppOutParam = IntPtr.Zero;

            ppInParam = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(NET_IN_PUSH_ANALYSE_PICTURE_FILE)));
            ppOutParam = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(NET_OUT_PUSH_ANALYSE_PICTURE_FILE)));

            Marshal.StructureToPtr(pInParam, ppInParam, false);
            Marshal.StructureToPtr(pOutParam, ppOutParam, false);
            result = OriginalSDK.CLIENT_PushAnalysePictureFile(lLoginID, ppInParam, ppOutParam, nWaitTime);
            NetGetLastError(result);
            if (result)
            {
                pOutParam = (NET_OUT_PUSH_ANALYSE_PICTURE_FILE)Marshal.PtrToStructure(ppOutParam, typeof(NET_OUT_PUSH_ANALYSE_PICTURE_FILE));
            }
        ...
        /// <summary>
        /// ,CLIENT_AddAnalyseTaskemDataSourceType EM_DATA_SOURCE_PUSH_PICFILE_BYRULE 
        ...
        /// 
        /// </summary>
        /// <param name="lAttachHandle">AttachAnalyseTaskResult</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <returns>failed return 0,successful return PlayGroupID 0，O</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lPlayGroupHandle">PlayGroupID ID</param>
        /// <param name="bPause">false:play；true:pause  false:；true: </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lPlayGroupHandle">ID</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// <param name="pInParam"></param>
        /// <param name="pOutParam"></param>
        /// <returns>failed return 0, successful return the handle 0，0</returns>
        ...
        /// (BSC)
        /// </summary>
        /// <returns>failed return 0, successful return non-0 0 0</returns>
        ...
        /// 
        /// </summary>
        /// <param name="lUpgradeID">StartUpgrade</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// ,lAttachHandleCLIENT_AttachBurnState
        /// </summary>
        /// <returns>failed return false, successful return true false true</returns> 
        ...
        /// ,lAttachHandleCLIENT_AttachBackupTaskState
        /// </summary>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value</param>
        /// <param name="pInParam">input info </param>
        /// <param name="pOutParam">output info </param>
        /// <param name="waittime">Wait timeout, million second</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">CLIENT_Login's return value</param>
        /// <param name="pstuInParam">input info </param>
        /// <param name="pstuOutParam">output info </param>
        /// <param name="waittime">Wait timeout, million second</param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="pInParam">input struct info </param>
        /// <param name="pOutParam">output struct info </param>
        /// <param name="waittime">waittime </param>
        /// <returns>failed return false, successful return true false true</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">Lonin return value ID</param>
        /// <param name="pstInParam">input info </param>
        /// <param name="pstOutParam">output info </param>
        /// <returns>failed return 0, successful return lFindHandle 0 lFindHandle</returns>
        ...
        /// </summary>
        /// <param name="lFindHandle">FindHandle value ID</param>
        /// <param name="pstInParam">input info </param>
        /// <param name="pstOutParam">output info </param>
        /// <returns>failed return -1, successful return 1  -1  1 </returns>
        ...
        /// <summary>
        ///  lAttachHandle AttachFaceDbDownLoadResult 
        ...
        /// </summary>
        [Obsolete("，NET_IN_SPLIT_SET_OSD_EX，IntPtr\n" +
            "This interface has been deprecated due to the excessive size of the NET_IN_SPLIT_SET_OSD_EX structure. Please use an overload with the parameter IntPtr")]
        ...
        /// </summary>
        [Obsolete("，NET_OUT_SPLIT_GET_OSD_EX，IntPtr\n" +
            "This interface has been deprecated due to the excessive size of the NET_OUT_SPLIT_GET_OSD_EX structure. Please use an overload with the parameter IntPtr")]
        ...
        /// set splite output OSD info ----expand interface (the memory of pInParam and pOutParam applyed and released by user),user malloc and free (pInParam's and pOutParam's)memory
        /// </summary>
        public static bool SetSplitOSDEx(IntPtr lLoginID, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetSplitOSDEx(lLoginID, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// get splite output OSD info ----expand interface (the memory of pInParam and pOutParam applyed and released by user),user malloc and free (pInParam's and pOutParam's)memory
        /// </summary>
        public static bool GetSplitOSDEx(IntPtr lLoginID, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetSplitOSDEx(lLoginID, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstInParam">[in] pstInParam ; [in] pstInParam Interface input parameters</param>
        /// <param name="pstOutParam">[out]pstOutParam ; [out] pstOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; True indicates success and false indicates failure</returns>
        ...
        /// <summary>
        /// 
        /// Get target detection token
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam ; [in] pInParam Interface input parameters</param>
        /// <param name="pOutParam">[out]pOutParam ; [out] pOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; True indicates success and false indicates failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: ; [in] lLoginID: Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: , ; [in] pstuInParam: Interface input parameters, memory resources are requested and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: , ; [out] pstuOutParam: Interface output parameters, memory resources are requested and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime: Interface timeout, in milliseconds</param>
        /// <returns>TRUEFALSE; TRUE means success, FALSE means failure</returns>
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Interface input parameters</param>
        /// <param name="pstuOutParam">[out]pstuOutParam ; [out]pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE indicates success FALSE indicates failure</returns>
        ...
        /// :set gps uuid
        /// </summary>
        /// <param name="lLoginID">[in]: LLONG :lLoginID ; [in]: LLONG :lLoginID login handle</param>
        /// <param name="pInParam">[in]: NET_IN_SUBCRIBE_GPS_INFO :pInParam , ; [in]: NET_IN_SUBCRIBE_GPS_INFO :pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out]: NET_OUT_SET_GPS_UUID_INFO :pOutParam , ; [out]: NET_OUT_SET_GPS_UUID_INFO :pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <returns>TRUE FALSE; True indicates success and false indicates failure</returns>
        ...
        /// <summary>
        /// ,nTypeDEVSTATE_ALARM_FRONTDISCONNECT，1(pBuf)
        ...
        /// </summary>
        public static bool SetAlarmRegionInfo(IntPtr lLoginID, EM_A_NET_EM_SET_ALARMREGION_INFO emType, IntPtr pstuInParam, IntPtr pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetAlarmRegionInfo(lLoginID, emType, pstuInParam, pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static IntPtr AttachLowRateWPAN(IntPtr lLoginID, ref NET_IN_ATTACH_LOWRATEWPAN pstInParam, ref NET_OUT_ATTACH_LOWRATEWPAN pstOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachLowRateWPAN(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }

        /// <summary>
        ///  < NET_IN_SET_POLLING_CONFIG pInParam > < NET_OUT_SET_POLLING_CONFIG pOutParam > 
        /// Set Polling Config
        /// </summary>
        public static bool SetPollingConfig(IntPtr lLoginID, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetPollingConfig(lLoginID, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: , ; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: , ; [out] pstuOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool TransmitCmd(IntPtr lLoginID, ref NET_IN_TRANSMIT_CMD pstuInParam, ref NET_OUT_TRANSMIT_CMD pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_TransmitCmd(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool ManualTest(IntPtr lLoginID, ref NET_IN_MANUAL_TEST pstuInParam, ref NET_OUT_MANUAL_TEST pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ManualTest(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool AddAlarmUser(IntPtr lLoginID, ref NET_IN_ADD_ALARM_USER pstuInParam, ref NET_OUT_ADD_ALARM_USER pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_AddAlarmUser(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool ModifyAlarmUser(IntPtr lLoginID, ref NET_IN_MODIFY_ALARM_USER pstuInParam, ref NET_OUT_MODIFY_ALARM_USER pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ModifyAlarmUser(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool ModifyAlarmUserPassword(IntPtr lLoginID, ref NET_IN_MODIFY_ALARM_USER_PASSWORD pstuInParam, ref NET_OUT_MODIFY_ALARM_USER_PASSWORD pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ModifyAlarmUserPassword(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool DeleteAlarmUser(IntPtr lLoginID, ref NET_IN_DELETE_ALARM_USER pstuInParam, ref NET_OUT_DELETE_ALARM_USER pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DeleteAlarmUser(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// --
        /// Real-time preview End-to-end audio and video encryption
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pstuInParam , ; [in] pInParam Interface input parameters</param>
        /// <param name="pOutParam">[out]pstuOutParam , ; [out]pOutParam Interface output parameters</param>
        /// <param name="dwWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; Returns the realplay handle</returns>
        public static IntPtr RealPlayForSpGdpr(IntPtr lLoginID, ref NET_IN_REALPLAY_FOR_SP_GDPR pInParam, ref NET_OUT_REALPLAY_FOR_SP_GDPR pOutParam, uint dwWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_RealPlayForSpGdpr(lLoginID, ref pInParam, ref pOutParam, dwWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// --
        /// Playback by time -- end-to-end encryption scheme
        ...
        /// </summary>
        /// <returns>0 0 </returns>
        public static IntPtr PlayBackByTimeForSpGdpr(IntPtr lLoginID, int nChannelID, ref NET_TIME lpStartTime, ref NET_TIME lpStopTime, IntPtr hWnd, fDownLoadPosCallBack cbDownLoadPos, IntPtr dwPosUser, fDataCallBack fDownLoadDataCallBack, IntPtr dwDataUser)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_PlayBackByTimeForSpGdpr(lLoginID, nChannelID, ref lpStartTime, ref lpStopTime, hWnd, cbDownLoadPos, dwPosUser, fDownLoadDataCallBack, dwDataUser);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool SetTourSource(IntPtr lLoginID, ref NET_IN_SET_TOUR_SOURCE pInParam, ref NET_OUT_SET_TOUR_SOURCE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetTourSource(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool GetTourSource(IntPtr lLoginID, ref NET_IN_GET_TOUR_SOURCE pInParam, ref NET_OUT_GET_TOUR_SOURCE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetTourSource(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool QuerySystemStatus(IntPtr lLoginID, ref NET_A_SYSTEM_STATUS pstuStatus, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_QuerySystemStatus(lLoginID, ref pstuStatus, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// partial enlarged
        /// </summary>
        public static bool SetDisplayRegion(IntPtr lPlayHandle, uint nRegionNum, ref NET_A_DISPLAYRREGION pSrcRect, IntPtr hDestWnd, bool bEnable)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetDisplayRegion(lPlayHandle, nRegionNum, ref pSrcRect, hDestWnd, bEnable);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool GetEncodeBitrate(IntPtr lLoginID, ref NET_IN_GET_ENCODE_BITRATE pstuInParam, ref NET_OUT_GET_ENCODE_BITRATE pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetEncodeBitrate(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool GetCourseRecordMode(IntPtr lLoginID, ref NET_IN_GET_COURSE_RECORD_MODE pInBuf, ref NET_OUT_GET_COURSE_RECORD_MODE pOutBuf, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetCourseRecordMode(lLoginID, ref pInBuf, ref pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool SetCourseRecordMode(IntPtr lLoginID, ref NET_IN_SET_COURSE_RECORD_MODE pInBuf, ref NET_OUT_SET_COURSE_RECORD_MODE pOutBuf, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetCourseRecordMode(lLoginID, ref pInBuf, ref pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool GetRealPreviewChannel(IntPtr lLoginID, ref NET_IN_GET_REAL_PREVIEW_CHANNEL pInBuf, ref NET_OUT_GET_REAL_PREVIEW_CHANNEL pOutBuf, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetRealPreviewChannel(lLoginID, ref pInBuf, ref pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="pRadiometryData">[in]pRadiometryData [IN] ，  fRadiometryAttachCB ; pRadiometryData [IN] radiometry data, obtained from fRadiometryAttachCB</param>
        /// <param name="pGrayImg">[out]pGrayImg [IN, OUT] ，，    （ *sizeof(unsigned short)）   unsigned short ，（ 0 ~ 16383），  ，; pGrayImg [IN, OUT] unachieved data, which is a grayscale image  you can pass NULL if this is not needed  you must ensure that the buffer is enough (no less than 'pixel number'*sizeof(unsigned short))  for each pixel, there is an unsigned short value representing the grayscale value (range: 0 ~ 16383)  and the ordering is top-left pixels in low memory address and lower-right pixels in high memory address</param>
        /// <param name="pTempForPixels">[out] pTempForPixels [IN, OUT]   ,,  （ *sizeof(float)）   float ，  ，; pTempForPixels [IN, OUT] The temperature buffer for each pixel can not be empty  otherwise,it will fail to return  you must ensure that the buffer is enough (no less than 'pixel number'*sizeof(float))  for each pixel, there is a float value representing temperature at pixel position, in centigrade  and the ordering is top-left pixels in low memory address and lower-right pixels in high memory address</param>
        /// <returns>TRUE ，FALSE ; TRUE for success, FALSE for failure</returns>
        public static bool RadiometryDataParse(ref NET_RADIOMETRY_DATA pRadiometryData, IntPtr pGrayImg, IntPtr pTempForPixels)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RadiometryDataParse(ref pRadiometryData, pGrayImg, pTempForPixels);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Get the status of added devices
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool GetDeviceInfoEx(IntPtr lLoginID, ref NET_IN_GET_DEVICE_INFO_EX pstuInParam, ref NET_OUT_GET_DEVICE_INFO_EX pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetDeviceInfoEx(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }

        /// <summary>
        ///   inParam = NET_IN_GET_DEVICE_LIST_INFO, outParam = NET_OUT_GET_DEVICE_LIST_INFO 
        /// interface of get added device info inParam = NET_IN_GET_DEVICE_LIST_INFO, outParam = NET_OUT_GET_DEVICE_LIST_INFO 
        /// </summary>
        public static bool GetDeviceInfo(IntPtr lLoginID, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetDeviceInfo(lLoginID, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool GetChannelInfo(IntPtr lLoginID, ref NET_IN_GET_CHANNEL_INFO pInParam, ref NET_OUT_GET_CHANNEL_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetChannelInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID: ; [in] lLoginID: login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam: , ; [in] pstuInParam: interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam: , ; [out] pstuOutParam: interface output parameters, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime: interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool PTZStartTour(IntPtr lLoginID, ref NET_IN_PTZ_START_TOUR pstuInParam, ref NET_OUT_PTZ_START_TOUR pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_PTZStartTour(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime: , ; [in] nWaitTime: interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool PTZStopTour(IntPtr lLoginID, ref NET_IN_PTZ_STOP_TOUR pstuInParam, ref NET_OUT_PTZ_STOP_TOUR pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_PTZStopTour(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out]pstuOutParam ; [out] pstOutParam Indicates the output parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE indicates success. FALSE indicates failure</returns>
        public static bool ManualSnapByEvent(IntPtr lLoginID, ref NET_IN_MANUALSNAP_BY_EVENT_INFO pstuInParam, ref NET_OUT_MANUALSNAP_BY_EVENT_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ManualSnapByEvent(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// , pInParampOutParam
        /// Get the parameter value of the Temperature Monitoring area, user malloc and free memory of pInParam and pOutParam
        /// </summary>
        public static bool RadiometryGetRandomRegionTemper(IntPtr lLoginID, ref NET_IN_RADIOMETRY_RANDOM_REGION_TEMPER pInParam, ref NET_OUT_RADIOMETRY_RANDOM_REGION_TEMPER pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RadiometryGetRandomRegionTemper(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE indicates success. FALSE Indicates failure</returns>
        public static bool GetStorageBoundTime(IntPtr lLoginID, ref NET_IN_GET_STORAGE_BOUND_TIME_INFO pstuInParam, ref NET_OUT_GET_STORAGE_BOUND_TIME_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetStorageBoundTime(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static IntPtr StartUpgradeEx2(IntPtr lLoginID, EM_UPGRADE_TYPE emType, IntPtr pchFileName, fUpgradeCallBackEx cbUpgrade, IntPtr dwUser)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_StartUpgradeEx2(lLoginID, emType, pchFileName, cbUpgrade, dwUser);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things subscription interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>; Attach handle</returns>
        public static IntPtr AttachThingsInfo(IntPtr lLoginID, ref NET_IN_THINGS_ATTACH pInParam, ref NET_OUT_THINGS_ATTACH pOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachThingsInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things Unsubscription interface
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle ; [in] lAttachHandle Attach handle</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool DetachThingsInfo(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachThingsInfo(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things get device list interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool GetThingsDevList(IntPtr lLoginID, ref NET_IN_THINGS_GET_DEVLIST pInParam, ref NET_OUT_THINGS_GET_DEVLIST pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetThingsDevList(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things get caps interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool GetThingsCaps(IntPtr lLoginID, ref NET_IN_THINGS_GET_CAPS pInParam, ref NET_OUT_THINGS_GET_CAPS pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetThingsCaps(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things Configuration acquisition interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool GetThingsConfig(IntPtr lLoginID, ref NET_IN_THINGS_GET pInParam, ref NET_OUT_THINGS_GET pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetThingsConfig(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things Configure settings interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam input param, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam output param, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool SetThingsConfig(IntPtr lLoginID, ref NET_IN_THINGS_SET pInParam, ref NET_OUT_THINGS_SET pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetThingsConfig(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static IntPtr StartRemoteUpgrade(IntPtr lLoginID, ref NET_IN_START_REMOTE_UPGRADE_INFO pInParam, ref NET_OUT_START_REMOTE_UPGRADE_INFO pOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_StartRemoteUpgrade(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// Stop remote upgrade
        /// </summary>
        public static bool StopRemoteUpgrade(IntPtr lUpgradeID)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopRemoteUpgrade(lUpgradeID);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// Things
        /// Smart electricity Things service interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="emType">[in] emType ; [in] emType service type</param>
        /// <param name="pInBuf">[in] pInBuf ，emType，; [in] pInBuf input param,memory resources are applied and released by the user</param>
        /// <param name="pOutBuf">[out] pOutBuf , emType，; [out] pOutBuf output param,memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool ThingsServiceOperate(IntPtr lLoginID, EM_THINGS_SERVICE_TYPE emType, IntPtr pInBuf, IntPtr pOutBuf, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_ThingsServiceOperate(lLoginID, emType, pInBuf, pOutBuf, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool QueryDeviceTimeEx(IntPtr lLoginID, ref NET_TIME_EX pDeviceTime, int waittime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_QueryDeviceTimeEx(lLoginID, ref pDeviceTime, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool SetupDeviceTimeEx(IntPtr lLoginID, ref NET_TIME_EX pDeviceTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetupDeviceTimeEx(lLoginID, ref pDeviceTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool FocusControl(IntPtr lLoginID, int nChannelID, uint dwFocusCommand, double nFocus, double nZoom, IntPtr reserved, int waittime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_FocusControl(lLoginID, nChannelID, dwFocusCommand, nFocus, nZoom, reserved, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Obtain all scheme information added by the user
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool GetClassify(IntPtr lLoginID, ref NET_IN_GET_CLASSIFY_INFO pstuInParam, ref NET_OUT_GET_CLASSIFY_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetClassify(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Training server training task management module obtains training task interface
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool FindTrainingTask(IntPtr lLoginID, ref NET_IN_FIND_TRAININGTASK_INFO pstuInParam, ref NET_OUT_FIND_TRAININGTASK_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_FindTrainingTask(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Subscription training task completion status
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the interface parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the outgoing parameter of the interface</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Timeout period of the interface, in milliseconds</param>
        /// <returns>; Return subscription handle</returns>
        public static IntPtr AttachTrainTask(IntPtr lLoginID, ref NET_IN_ATTACH_TRAIN_TASK_INFO pstuInParam, ref NET_OUT_ATTACH_TRAIN_TASK_INFO pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachTrainTask(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle ; [in] lAttachHandle Subscription handle</param>
        /// <returns>TRUE FALSE; TRUE Indicates success. FALSE Indicates failure</returns>
        public static bool DetachTrainTask(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachTrainTask(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        public static bool GetUserInfoAll(IntPtr lLoginID, ref NET_IN_GET_USER_ALL_INFO pstuInParam, ref NET_OUT_GET_USER_ALL_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetUserInfoAll(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// 
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID </param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam </param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam </param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime , </param>
        /// <returns>; </returns>
        public static IntPtr StartFindAccessFingerprint(IntPtr lLoginID, ref NET_IN_FINGERPRINT_START_FIND_INFO pstuInParam, ref NET_OUT_FINGERPRINT_START_FIND_INFO pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_StartFindAccessFingerprint(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// 
        /// </summary>
        /// <param name="lFindHandle">[in] lFindHandle ; [in] lFindHandle </param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam </param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam </param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime , </param>
        /// <returns>TRUE  FALSE; TRUE  FALSE</returns>
        public static bool DoFindAccessFingerprint(IntPtr lFindHandle, ref NET_IN_FINGERPRINT_DO_FIND_INFO pstuInParam, ref NET_OUT_FINGERPRINT_DO_FIND_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DoFindAccessFingerprint(lFindHandle, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="lFindHandle">[in] lFindHandle ; [in] lFindHandle </param>
        /// <returns>TRUE  FALSE; TRUE  FALSE</returns>
        public static bool StopFindAccessFingerprint(IntPtr lFindHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopFindAccessFingerprint(lFindHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        {
            bool result = false;
            result = OriginalSDK.CLIENT_TrafficSnapByNetwork(lLoginID, nChannelID, ref pstInParam, ref pstOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Set window scene information
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ID; [in] lLoginID Login ID</param>
        /// <param name="pInParam">[in] pInParam ; [in] pInParam Interface input parameter</param>
        /// <param name="pOutParam">[out] pOutParam ; [out] pOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout time in milliseconds</param>
        /// <returns>TRUE  FALSE; TRUE indicates success, FALSE indicates failure</returns>
        public static bool SetSplitWindowsInfo(IntPtr lLoginID, IntPtr pInParam, IntPtr pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetSplitWindowsInfo(lLoginID, pInParam, pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool SetSplitTopWindow(IntPtr lLoginID, ref NET_IN_SPLIT_SET_TOP_WINDOW pInParam, ref NET_OUT_SPLIT_SET_TOP_WINDOW pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetSplitTopWindow(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// (pInparam, pOutParam)
        /// close window,user malloc and free (pInParam's and pOutParam's)memory
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool CloseSplitWindow(IntPtr lLoginID, ref NET_IN_SPLIT_CLOSE_WINDOW pInParam, ref NET_OUT_SPLIT_CLOSE_WINDOW pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_CloseSplitWindow(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID login handle</param>
        /// <param name="pstuInParam">[in] pstInParam ; [in] pstInParam Interface input parameter</param>
        /// <param name="pstuOutParam">[out] pstOutParam ; [out] pstOutParam Interface output parameter</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>TRUE,FALSE; TRUE means success FALSE means failure</returns>
        public static bool GetIVSEventDetail(IntPtr lLoginID, ref NET_IN_GET_IVSEVENT_DETAIL_INFO pstuInParam, ref NET_OUT_GET_IVSEVENT_DETAIL_INFO pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetIVSEventDetail(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// ，，，pOutParam
        /// download piece file,user malloc memory of pInParam and pOutParam
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool DownloadPieceFile(IntPtr lLoginID, ref NET_IN_DOWNLOAD_PIECE_FILE pInParam, ref NET_OUT_DOWNLOAD_PIECE_FILE pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DownloadPieceFile(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool GetHeatMapsDirectly(IntPtr lLoginID, ref NET_IN_GET_HEATMAPS_INFO pInParam, ref NET_OUT_GET_HEATMAPS_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetHeatMapsDirectly(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool AddMission(IntPtr lLoginID, ref NET_IN_ADD_MISSION pstInParam, ref NET_OUT_ADD_MISSION pstOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_AddMission(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }

        /// <summary>
        /// (lpInParam, lpOutParam,emType)
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool QueryNetStat(IntPtr lLoginID, EM_NET_QUERY_TYPE emType, IntPtr lpInParam, int nInParamLen, IntPtr lpOutParam, int nOutParamLen, IntPtr pError, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_QueryNetStat(lLoginID, emType, lpInParam, nInParamLen, lpOutParam, nOutParamLen, pError, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// Get Config Partly
        /// </summary>
        public static bool GetConfigPartly(IntPtr lLoginID, NET_EM_CFGPARTLY_OPERATE_TYPE emCfgOpType, ref NET_CFGPARTLY_OPERATE_FILTER pstuFilter, IntPtr lpOutBuffer, int nOutBufferSize, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetConfigPartly(lLoginID, emCfgOpType, ref pstuFilter, lpOutBuffer, nOutBufferSize, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID login handle</param>
        /// <param name="pInParam">[in] pstInParam ; [in] pstInParam interface input parameter</param>
        /// <param name="pOutParam">[out]pstOutParam ; [out]pstOutParam interface output parameter</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime interface timeout, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE means success FALSE means failure</returns>
        public static bool GetHygrothermographInfo(IntPtr lLoginID, ref NET_IN_GET_HYGROTHERMOGRAPH_INFO pInParam, ref NET_OUT_GET_HYGROTHERMOGRAPH_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetHygrothermographInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool GetNumberStatGroupSummary(IntPtr lLoginID, ref NET_IN_NUMBERSTATGROUPSUMMARY_INFO pInParam, ref NET_OUT_NUMBERSTATGROUPSUMMARY_INFO pOutParam, int waittime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetNumberStatGroupSummary(lLoginID, ref pInParam, ref pOutParam, waittime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam The input parameters for the interface, memory resources are allocated and released by the user</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam The output parameters for the interface, memory resources are allocated and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout, in milliseconds</param>
        /// <returns>; Return subscription handle</returns>
        public static IntPtr AttachElevatorFloorCounter(IntPtr lLoginID, ref NET_IN_ATTACH_ELEVATOR_FLOOR_COUNTER_INFO pstuInParam, ref NET_OUT_ATTACH_ELEVATOR_FLOOR_COUNTER_INFO pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachElevatorFloorCounter(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Unsubscribe from real-time data in the elevator
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle ; [in] lAttachHandle Subscription handle</param>
        /// <returns>TRUE FALSE; indicates success, FALSE indicates failure</returns>
        public static bool DetachElevatorFloorCounter(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachElevatorFloorCounter(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool MonitorWallGetWindowInfo(IntPtr lLoginID, ref NET_IN_MW_GET_WINODW_INFO pInParam, ref NET_OUT_MW_GET_WINDOW_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_MonitorWallGetWindowInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// The access control device starts to capture the new card
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool AccessControlCaptureNewCard(IntPtr lLoginID, ref NET_IN_ACCESSCONTROL_CAPTURE_NEWCARD pInParam, ref NET_OUT_ACCESSCONTROL_CAPTURE_NEWCARD pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_AccessControlCaptureNewCard(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool SetGroupInfoForChannel(IntPtr lLoginID, ref NET_IN_SET_GROUPINFO_FOR_CHANNEL pstInParam, ref NET_OUT_SET_GROUPINFO_FOR_CHANNEL pstOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetGroupInfoForChannel(lLoginID, ref pstInParam, ref pstOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// ，，()
        /// Automatic calibration, blocking interface, very time-consuming (in minutes)
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Interface input parameter</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout time, in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE indicates success, FALSE indicates failure</returns>
        public static bool StartAutoCalibrate(IntPtr lLoginID, ref NET_IN_START_AUTO_CALIBRATE pstuInParam, ref NET_OUT_START_AUTO_CALIBRATE pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StartAutoCalibrate(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Subscription calibration status
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Interface input parameters</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Interface output parameters</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout time, in milliseconds</param>
        /// <returns>; Return subscription handle</returns>
        public static IntPtr AttachCalibrateStatus(IntPtr lLoginID, ref NET_IN_ATTACH_CALIBRATE_STATUS pstuInParam, ref NET_OUT_ATTACH_CALIBRATE_STATUS pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachCalibrateStatus(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Unsubscribe from calibration status
        /// </summary>
        /// <param name="lAttachHandle">[in] lAttachHandle ; [in] lAttachHandle Subscription handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Interface input parameters</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Interface output parameters</param>
        /// <returns>TRUE FALSE; TRUE indicates success, FALSE indicates failure</returns>
        public static bool DetachCalibrateStatus(IntPtr lAttachHandle, ref NET_IN_DETACH_CALIBRATE_STATUS pstuInParam, ref NET_OUT_DETACH_CALIBRATE_STATUS pstuOutParam)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachCalibrateStatus(lAttachHandle, ref pstuInParam, ref pstuOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool SetSplitWindowRect(IntPtr lLoginID, ref NET_IN_SPLIT_SET_RECT pInParam, ref NET_OUT_SPLIT_SET_RECT pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetSplitWindowRect(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// (pstuSplitSrc)
        /// get display source,user malloc and free pstuSplitSrc's memory
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool GetSplitSource(IntPtr lLoginID, int nChannel, int nWindow, IntPtr pstuSplitSrc, int nMaxCount, ref int nRetCount, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetSplitSource(lLoginID, nChannel, nWindow, pstuSplitSrc, nMaxCount, ref nRetCount, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool GetTemporaryToken(IntPtr lLoginID, ref NET_IN_GET_TEMPORARY_TOKEN pstuInParam, ref NET_OUT_GET_TEMPORARY_TOKEN pstuOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetTemporaryToken(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// , 
        /// Get capability information of sub business, called by main business module
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , (, ); [in] nWaitTime Interface timeout in milliseconds(It does not take effect at present. It is reserved here for subsequent expansion)</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool GetSubBusinessCaps(IntPtr lLoginID, ref NET_IN_GET_SUBBIZ_CAPS pInParam, ref NET_OUT_GET_SUBBIZ_CAPS pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_GetSubBusinessCaps(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// sdk
        /// Create sub business module
        /// </summary>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <returns>sdk，0 0; Sub business module handle, Non 0 means success and 0 means failure</returns>
        public static IntPtr CreateSubBusinessModule(ref NET_IN_CREAT_SUB_BUSINESS_MDL_INFO pInParam, ref NET_OUT_CREAT_SUB_BUSINESS_MDL_INFO pOutParam)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_CreateSubBusinessModule(ref pInParam, ref pOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Start sub link listen server
        /// </summary>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <returns>, 0 0; Sub libk listen server handle, Non 0 means success and 0 means failure</returns>
        public static IntPtr StartSubLinkListenServer(ref NET_IN_START_SUBLINK_LISTEN_SERVER pInParam, ref NET_OUT_START_SUBLINK_LISTEN_SERVER pOutParam)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_StartSubLinkListenServer(ref pInParam, ref pOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// , 
        /// Send the information required to create a sub connection to the device, called by main business module
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Interface input parameters, memory resources are applied and released by the user</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Interface output parameters, memory resources are applied and released by the user</param>
        /// <param name="nWaitTime">[in] nWaitTime , ; [in] nWaitTime Interface timeout in milliseconds</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool TransferSubLinkInfo(IntPtr lLoginID, ref NET_IN_TRANSFER_SUBLINK_INFO pInParam, ref NET_OUT_TRANSFER_SUBLINK_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_TransferSubLinkInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Set param about private tunnel
        /// </summary>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Input param, resources are requested and released by users</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Output param, resources are requested and released by users</param>
        /// <returns>TRUE FALSE; TRUE:Success FALSE:Failed</returns>
        public static bool SetTransmitTunnelParam(ref NET_IN_SET_TRANSMITTUNNEL_PARAM pInParam, ref NET_OUT_SET_TRANSMITTUNNEL_PARAM pOutParam)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetTransmitTunnelParam(ref pInParam, ref pOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="lSubBizHandle">[in] lSubBizHandle sdk，CLIENT_CreateSubBusinessModule; [in] lSubBizHandle Sub business handle, it is returned by CLIENT_CreateSubBusinessModule</param>
        /// <param name="pInParam">[in] pInParam , ; [in] pInParam Input param, resosurces are requested and released by users</param>
        /// <param name="pOutParam">[out] pOutParam , ; [out] pOutParam Output param, resources are requested and released by userss</param>
        /// <returns>LLONG ，0 0; LLONG Private tunnel handle, Non 0 means success and 0 means failure</returns>
        public static IntPtr CreateTransmitTunnel(IntPtr lSubBizHandle, ref NET_IN_CREATE_TRANSMIT_TUNNEL pInParam, ref NET_OUT_CREATE_TRANSMIT_TUNNEL pOutParam)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_CreateTransmitTunnel(lSubBizHandle, ref pInParam, ref pOutParam);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Destroy private tunnel
        /// </summary>
        /// <param name="lTransmitHandle">[in] lTransmitHandle ，CLIENT_CreateTransmitTunnel; [in] lTransmitHandle Private tunnel handle, it is returned by CLIENT_CreateTransmitTunnel</param>
        /// <returns>TRUE FALSE; TRUE:Success FALSE:Failed</returns>
        public static bool DestroyTransmitTunnel(IntPtr lTransmitHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DestroyTransmitTunnel(lTransmitHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// sdk
        /// Destroy sub business module
        /// </summary>
        /// <param name="lSubBizHandle">[in] lSubBizHandle sdk，CLIENT_CreateSubBusinessModule; [in] lSubBizHandle:sub business module handle, it is returned by CLIENT_CreateSubBusinessModule</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool DestroySubBusinessModule(IntPtr lSubBizHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DestroySubBusinessModule(lSubBizHandle);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Stop sub link listen server
        /// </summary>
        /// <param name="lListenServer">[in] lListenServer ，CLIENT_StartSubLinkListenServer; [in] lListenServer:sub link listen server handle, it is returned by CLIENT_StartSubLinkListenServer</param>
        /// <returns>TRUE FALSE; TRUE:success FALSE:failed</returns>
        public static bool StopSubLinkListenServer(IntPtr lListenServer)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_StopSubLinkListenServer(lListenServer);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool RadiometryGetCurrentHotColdSpotInfo(IntPtr lLoginID, ref NET_IN_RADIOMETRY_CURRENTHOTCOLDSPOT_INFO pInParam, ref NET_OUT_RADIOMETRY_CURRENTHOTCOLDSPOT_INFO pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_RadiometryGetCurrentHotColdSpotInfo(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 
        /// Access control ID device to obtain target
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool AccessControlCaptureCmd(IntPtr lLoginID, ref NET_IN_ACCESSCONTROL_CAPTURE_CMD pInParam, ref NET_OUT_ACCESSCONTROL_CAPTURE_CMD pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_AccessControlCaptureCmd(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// </summary>
        /// <returns>TRUE FALSE</returns>
        public static bool SetPersonInfoInputResult(IntPtr lLoginID, ref NET_IN_PERSON_INFO_INPUT_RESULT pInParam, ref NET_OUT_PERSON_INFO_INPUT_RESULT pOutParam, int nWaitTime)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_SetPersonInfoInputResult(lLoginID, ref pInParam, ref pOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <summary>
        /// 485
        /// Subscribe to 485 real-time data
        /// </summary>
        /// <param name="lLoginID">[in] lLoginID ; [in] lLoginID Login handle</param>
        /// <param name="pstuInParam">[in] pstuInParam ; [in] pstuInParam Indicates the input parameter of the interface</param>
        /// <param name="pstuOutParam">[out] pstuOutParam ; [out] pstuOutParam Indicates the output parameter of the interface</param>
        ...
        public static IntPtr AttachIotboxComm(IntPtr lLoginID, ref NET_IN_ATTACH_IOTBOX_COMM pstuInParam, ref NET_OUT_ATTACH_IOTBOX_COMM pstuOutParam, int nWaitTime)
        {
            IntPtr result = IntPtr.Zero;
            result = OriginalSDK.CLIENT_AttachIotboxComm(lLoginID, ref pstuInParam, ref pstuOutParam, nWaitTime);
            NetGetLastError(result);
            return result;
        }
        ...
        /// <param name="lAttachHandle">[in] lAttachHandle ; [in] lAttachHandle Subscription handle</param>
        /// <returns>TRUE FALSE; TRUE indicates success. FALSE Indicates failure</returns>
        public static bool DetachIotboxComm(IntPtr lAttachHandle)
        {
            bool result = false;
            result = OriginalSDK.CLIENT_DetachIotboxComm(lAttachHandle);
            NetGetLastError(result);
            return result;
        }
    ...
    /// 
    /// </summary>
    /// <param name="lLoginID">user LoginID:Login's returns value ID</param>
    /// <param name="pchDVRIP">device IP IP</param>
    ...
    /// </summary>
    /// <param name="lLoginID">user LoginID:Login's returns value ID</param>
    /// <param name="pchDVRIP">device IP,string type IP</param>
    /// <param name="nDVRPort">device prot </param>
    ...
    /// YUV
    /// </summary>
    /// <param name="lPlaybackHandle">monitor handle </param>
    /// <param name="pBuffer">byte array, length is dwBufSize 
    ///                      <para>callback data, except type 0, other type is base on frame, one frame data per callback</para></param>
    /// <param name="dwBufSize">pBuffer's size </param>
    /// <param name="param">pointer to parameter structure,based on different type 
    ...
    /// <param name="dwUser">user data,which input above </param>
    /// <param name="pReserved">reserved </param>
    public delegate void fYUVDataCallBack(IntPtr lPlaybackHandle, IntPtr pBuffer, uint dwBufSize, IntPtr param, IntPtr dwUser, IntPtr reserved);
    ...
    /// 
    /// </summary>
    /// <param name="lRealHandle">monitoring handle </param>
    ...
    /// VK(pBufferSDK),dwErrorNET_NOERROR,NET_ERROR_VK_INFO_DECRYPT_FAILED
    /// </summary>
    /// <param name="lRealHandle">monitoring handle </param>
    /// <param name="pBuffer">NET_VKINFO struct, length is dwBufSize NET_VKINFO</param>
    /// <param name="dwError">error code for example:NET_NOERROR,NET_ERROR_VK_INFO_DECRYPT_FAILED </param>
    /// <param name="dwUser">user data,which input above </param>
    /// <param name="pReserved">reserved </param>
    ...
    /// vt
    /// </summary>
    /// <param name="instId">vt instance id vtID</param>
    /// <param name="ulRegisterId">register id ID</param>
    ...
    /// </summary>
    /// <param name="lRealHandle">playback handle </param>
    /// <param name="pDataCallBack">NET_DATA_CALL_BACK_INFO </param>
    /// <param name="dwUser">user data,which input above </param>
    /// <returns>reserved</returns>
    ...
    /// 
    /// </summary>
    /// <param name="lPlayHandle">download handle </param>
    /// <param name="dwTotalSize">total size of this play(kb) </param>
    ...
    /// <param name="bAlarmAckFlag">true:the event is affirmable event;false:the event is not affirmable event TRUE,；FALSE,</param>
    /// <param name="nEventID">used to AlarmAck function,when the bAlarmAckFlag is true,this paramter is valid  CLIENT_AlarmAck , bAlarmAckFlag  TRUE ,</param>
    ...
    ///  
    /// </summary>
    /// <param name="lAttachHandle">return value of AttachVideoStatSummary AttachVideoStatSummary</param>
    /// <param name="pBuf">pointer to NET_VIDEOSTAT_SUMMARY </param>
    /// <param name="dwBufLen">buffer length </param>
    /// <param name="dwUser">user data of AttachVideoStatSummary </param>
    ...
    /// </summary>
    /// <param name="lLoginID">loginID:login returns value ID</param>
    /// <param name="lTransComChannel">TransCom Channel </param>
    /// <param name="pBuffer">pointer to TransCom data </param>
    /// <param name="dwBufSize">buffer length </param>
    /// <param name="dwUser">user data from CreateTransComChannel </param>
    ...
    /// <param name="dwUserData">user data from _SetSubcribeGPSCallBackEX2 function </param>
    /// <param name="reserved">reserved</param>
    public delegate void fGPSRevEx2(IntPtr lLoginID, IntPtr pGpsInfo, IntPtr dwUserData, IntPtr reserved);


    /// <summary>
    /// , lAttachHandle  CLIENT_AttachAnalyseTaskState 
    /// </summary>
    /// <param name="lAttachHandle"></param>
    ...
    /// <summary>
    /// , lAttachHandle  CLIENT_AttachAnalyseResultState 
    /// </summary>
    /// <param name="lAttachHandle"></param>
    ...
    /// 
    /// </summary>
    /// <param name="lRealHandle">uploadfile handle </param>
    /// <param name="nTotalSize">file total size </param>
    /// <param name="nSendSize">file send size </param>
    /// <param name="dwUser">user data,which input above </param>
    /// <returns>reserved</returns>
    ...
    // 
    // nTotalSize = 0, nSendSize = -1 
    // nTotalSize = 0, nSendSize = -2 
    // nTotalSize = 0, nSendSize = -3 
    // nTotalSize = 0, nSendSize = -4 
    // nTotalSize = -1, nSendSize = XX 
    // nTotalSize = XX, nSendSize = XX 
    ...
    /// <summary>
    /// , lAttachHandle CLIENT_AttachCustomSnapInfo 
    /// </summary>
    /// <param name="lAttachHandle"></param>
    ...
    /// Bus, lAttachHandle CLIENT_AttachBusState 
    /// </summary>
    ...
    /// ,lRemoteUploadFileID  CLIENT_StartRemoteUploadFile 
    /// </summary>
    ...
    /// ,lAttachHandleCLIENT_AttachBurnState, 1,pBuf->dwSize == nBufLen,pBufNET_CB_BURNSTATE
    /// </summary>
    ...
    /// ,lAttachHandleCLIENT_AttachBackupTaskState,pBufNET_CB_BACKUPTASK_STATE
    /// </summary>
    ...
    /// <summary>
    /// , lAttachHandle CLIENT_AttachFaceDbDownLoadResult  < pstResult = NET_CB_FACEDB_DOWNLOAD_RESULT >
    ...
    /// <summary>
    ///  < pstStates = NET_CB_MULTIFACE_DETECT_STATE >
    ...
    /// <summary>
    ///  < pstStates = NET_CB_MULTIFACE_DETECT_STATE_EX >
    ...
    /// <summary>
    ///  pstFaceDbState : NET_IMPORT_FACEDB_STATE
    ...
    /// <summary>
    ///  pstFaceDbState : NET_EXPORT_FACEDB_STATE
    ...
    /// <summary>
    /// ,lAttachHandleCLIENT_AttachLowRateWPAN
    /// Order wireless code info call function origin, lAttachHandle is CLIENT_AttachLowRateWPAN return valud
    /// </summary>
    public delegate void fAttachLowRateWPANCB(IntPtr lLoginID, IntPtr lAttachHandle, IntPtr stuBuf, EM_A_NET_CODEID_ERROR_TYPE emError, IntPtr dwUser);

    /// <summary>
    /// , lAttachHandleCLIENT_AttachThingsInfo
    /// things data state callback function
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle ; [out] lAttachHandle subscription handle</param>
    /// <param name="pstResult">[out] pstResult ; [out] pstResult things data info</param>
    /// <param name="dwUserData">[out] dwUserData ; [out] dwUserData User Info</param>
    /// <returns>void; void</returns>
    public delegate void fThingsCallBack(IntPtr lAttachHandle, IntPtr pstResult, IntPtr dwUserData);

    /// <summary>
    /// 
    /// RemoteUpgrade callback
    /// </summary>
    public delegate void fRemoteUpgradeCallBack(IntPtr lLoginID, IntPtr lUpgradeID, EM_REMOTE_UPGRADE_CB_TYPE emState, long nParam1, long nParam2, IntPtr dwUser);

    /// <summary>
    /// (pBufSDK)
    /// Alarm message callback function original shape
    /// </summary>
    public delegate bool fMessCallBack(int lCommand, IntPtr lLoginID, IntPtr pBuf, uint dwBufLen, IntPtr pchDVRIP, int nDVRPort, IntPtr dwUser);

    /// <summary>
    /// , lAttachHandle  CLIENT_AttachTrainTask 
    /// Prototype callback function for subscription training task completion interface, with lAttachHandle as CLIENT_ The return value of the AttachTrainTask interface
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle ; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuTrainTaskInfo">[out] pstuTalkDevTaskState ; [out] pstuTalkDevTaskState Operation execution status information</param>
    /// <param name="dwUser">[out] dwUser ; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifyTrainTaskdata(IntPtr lAttachHandle, IntPtr pstuTrainTaskInfo, IntPtr dwUser);
    /// <summary>
    /// 
    /// Event Details Callback
    /// </summary>
    /// <param name="pstuNotifyIVSEventDetailInfo">[out] pstuNotifyIVSEventDetailInfo ; [out] pstuNotifyIVSEventDetailInfo Obtain detailed information about the event</param>
    /// <param name="dwUser">[out] dwUser ; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifyIVSEventDetail(IntPtr pstuNotifyIVSEventDetailInfo, IntPtr dwUser);

	/// <summary>
    /// , lAttachHandle  CLIENT_AttachElevatorFloorCounter 
    ...
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle ; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuElevatorFloorCounterInfo">[out] pstuCentraProxyActionInfo ; [out] pstuCentraProxyActionInfo Operation execution status information</param>
    /// <param name="dwUser">[out] dwUser ; [out] dwUser user information</param>
    /// <returns>void; void</returns>
    public delegate void fNotifyElevatorFloorCounterdata(IntPtr lAttachHandle, IntPtr pstuElevatorFloorCounterInfo, IntPtr dwUser);

    /// <summary>
    /// , lAttachHandle  CLIENT_AttachCalibrateStatus 
    /// Prototype of callback function for subscription calibration status interface, lAttachHandle is the return value of CLIENT_AttachCalibrateStatus
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle ; [out] lAttachHandle Subscription handle</param>
    /// <param name="pstuCalibrateStatusInfo">[out] pstuCalibrateStatusInfo ; [out] pstuCalibrateStatusInfo Calibration status information</param>
    /// <param name="dwUser">[out] dwUser ; [out] dwUser User Information</param>
    /// <returns>void; void</returns>
    ...
    /// </summary>
    /// <param name="lListenServer">[out] lListenServer , CLIENT_StartSubLinkListenServer; [out] lListenServer:Sublink server handle, it is returned by CLIENT_StartSubLinkListenServer</param>
    /// <param name="lSubBizHandle">[out] lSubBizHandle sdk, CLIENT_CreateSubBusinessModule; [out] lSubBizHandle: sub business module handle, it is returned by CLIENT_CreateSubBusinessModule</param>
    /// <param name="pstSubLinkCallBack">[out] pstSubLinkCallBack ; [out] pstSubLinkCallBack: callback info of sublink server @retval void</param>
    /// <returns>void</returns>
    public delegate void fSubLinkServiceCallBack(IntPtr lListenServer, IntPtr lSubBizHandle, IntPtr pstSubLinkCallBack);

    /// <summary>
    /// 
    /// Private tunnel disconnect callback function
    /// </summary>
    /// <param name="lSubBizHandle">[out] lSubBizHandle , CLIENT_CreateSubBusinessModule; [out] lSubBizHandle: Sub business handle, it is returned by CLIENT_CreateSubBusinessModule</param>
    /// <param name="lOperateHandle">[out] lOperateHandle ; [out] lOperateHandle: Opreate handle</param>
    /// <param name="pstDisConnectInfo">[out] pstDisConnectInfo ; [out] pstDisConnectInfo: Disconnect callback info of private tunnel</param>
    /// <returns>void; void</returns>
    public delegate void fTransmitDisConnectCallBack(IntPtr lSubBizHandle, IntPtr lOperateHandle, IntPtr pstDisConnectInfo);

    /// <summary>
    /// 
    /// Call back function of subbiz disconnect
    /// </summary>
    /// <param name="lSubBizHandle">[out] lSubBizHandle sdk, CLIENT_CreateSubBusinessModule; [out] lSubBizHandle: Sub business module handle, it is retuened by CLIENT_CreateSubBusinessModule</param>
    /// <param name="lOperateHandle">[out] lOperateHandle ; [out] lOperateHandle: Operate handle</param>
    /// <param name="pstDisConnectInfo">[out] pstDisConnectInfo ; [out] pstDisConnectInfo: Call back info of disconnect @retval void</param>
    /// <returns>void</returns>
    public delegate void fSubBizDisConnectCallBack(IntPtr lSubBizHandle, IntPtr lOperateHandle, IntPtr pstDisConnectInfo);

    /// <summary>
    /// 485, lAttachHandle  CLIENT_AttachIotboxComm 
    /// Subscribe to 485 real-time data interface callback Function prototype, lAttachHandle is the return value of CLIENT_AttachIotboxComm
    /// </summary>
    /// <param name="lAttachHandle">[out] lAttachHandle ; [out] lAttachRecalHandle Subscription handle</param>
    /// <param name="pstuIotboxComm">[out] pstuIotboxComm 485; [out] pstuIotboxComm Subscribed 485 real-time data</param>
    /// <param name="dwUser">[out] dwUser ; [out] dwUser user information</param>
    /// <returns>void; void</returns>
